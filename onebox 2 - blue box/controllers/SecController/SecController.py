...
class RobotController(Supervisor):  # Use Supervisor instead of Robot
    def __init__(self):
        ...
        self.sector_coordinates = {
            ...
            "Green": [-0.501377191783167, 3.37684753469068], #-0.6875144492298266, -2.5710764570773796 
    ...
    def detect_box_camera(self):
        ...
        rotation_speed = 6  # Adjust rotation speed if needed
            ...
            for y in range(height):
                for x in range(width):
                    ...
                    if r > 200 and g < 50 and b < 50:
                        detected_color_now = "Red"
                    # Detect yellow color
                    elif r > 200 and g > 200 and b < 50:
                        detected_color_now = "Yellow"
                    # Detect green colo
                    # elif g > 150 and r < 100 and b < 100
                    elif r < 100 and g > 150 and b < 100:
                        print("green detected")
                        detected_color_now = "Green"
                    # Detect blue color
                    elif r < 50 and g < 50 and b > 200:
                        detected_color_now = "Blue"
                    else:
                        detected_color_now = None

                    if detected_color_now == detected_color:
                        ...
                        print(f"{detected_color.capitalize()} box detected at angle: {angle_to_box:.2f} radians")
                         # Perform additional rotation
                        additional_rotation=0.5
                        print(f"Rotating an additional {additional_rotation} radians...")
                        additional_rotation_time = additional_rotation / angular_velocity
                        self.set_motors_velocity(rotation_speed, -rotation_speed, rotation_speed, -rotation_speed)
                        self.step(int(additional_rotation_time * 10))  # Step for the additional time
                        print("done additional rotating")
                        self.set_motors_velocity(0, 0, 0, 0)
